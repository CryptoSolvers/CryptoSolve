from term import Term, Function, Variable, Constant, FuncTerm, Equation
from typing import Tuple, Dict, List, Optional, Set
from term_forest import Term_Forest
...
def test_big():
	...
	print(clone)
	print("clone contains x ", clone.contains(x))
	print("clone contains g(y) ", clone.contains(g(y)))
