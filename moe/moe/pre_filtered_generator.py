...
from algebra import Constant, Function, Term, Variable, FuncTerm
from xor.xor import xor

__all__ = ['PreFilteredMOOGenerator']

class PreFilteredMOOGenerator():
	"""
	...
	def __init__(self, max_history: int = 2, max_f_depth: int = 3):
		...
		self.branch_iter: Iterator[Term] = iter(self.tree[0])
